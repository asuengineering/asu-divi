					...
					<div id="header-main" class="col-12">
						<nav class="navbar navbar-expand-xl" aria-label="Main">
							...
							<a class="navbar-brand" href="https://www.asu.edu">
								<img class="vert" src="<?php echo get_stylesheet_directory_uri(); ?>/src/img/asu-unity/asu-logo/asu-university-vert-maroongold.png" alt="Arizona State University" />
								<img class="horiz" src="<?php echo get_stylesheet_directory_uri(); ?>/src/img/asu-unity/asu-logo/asu-university-horiz-maroongold.png" alt="Arizona State University" />
							</a>
