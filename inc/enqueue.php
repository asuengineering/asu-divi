...
function uds_divi_enqueue_scripts() {
	...
	wp_enqueue_script ( 'cookie-consent-preact', 'https://unpkg.com/preact@10.5.13/dist/preact.min.js', array(), null, true );
	wp_enqueue_script ( 'cookie-consent', get_stylesheet_directory_uri() . '/src/js/uds-bootstrap/cookie-consent.js', array('cookie-consent-preact'), null, true );

	wp_enqueue_script ( 'asu-divi', get_stylesheet_directory_uri() . '/js/theme.js', array(), null, true );
